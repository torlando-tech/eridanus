...
enum class PresetTheme(
    ...
    ERIDANUS(
        ...
        description = "Deep blue and amber tones inspired by the celestial river",
    ),
    DYNAMIC(
        displayName = "Dynamic",
    ...
    fun getColorScheme(isDarkTheme: Boolean): ColorScheme {
        return when (this) {
            ERIDANUS -> if (isDarkTheme) eridanusDarkScheme else eridanusLightScheme
            ...
            DYNAMIC -> if (isDarkTheme) eridanusDarkScheme else eridanusLightScheme // Fallback
        }
    }

    fun getPreviewColors(isDarkTheme: Boolean): Triple<Color, Color, Color> {
        return when (this) {
            ERIDANUS -> if (isDarkTheme) Triple(EridanusBlue80, EridanusAmber80, EridanusTeal80) else Triple(EridanusBlue40, EridanusAmber40, EridanusTeal40)
...
// Eridanus theme (default) - Deep Blue and Amber (celestial river)
private val eridanusDarkScheme = darkColorScheme(
    primary = EridanusBlue80,
    onPrimary = EridanusOnPrimary80,
    primaryContainer = EridanusContainer80,
    onPrimaryContainer = EridanusOnContainer80,
    secondary = EridanusAmber80,
    onSecondary = EridanusOnSecondary80,
    tertiary = EridanusTeal80,
    onTertiary = EridanusOnTertiary80,
    surfaceVariant = EridanusSurface80,
    outline = EridanusOutline80,
    outlineVariant = EridanusOutline80,
)

private val eridanusLightScheme = lightColorScheme(
    primary = EridanusBlue40,
    onPrimary = Color.White,
    primaryContainer = EridanusContainer40,
    onPrimaryContainer = EridanusOnContainer40,
    secondary = EridanusAmber40,
    onSecondary = Color.White,
    tertiary = EridanusTeal40,
    onTertiary = Color.White,
    surfaceVariant = EridanusSurface40,
    outline = EridanusOutline40,
    outlineVariant = EridanusOutline40,
)
